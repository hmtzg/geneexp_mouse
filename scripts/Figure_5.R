...
ggsave('./results/figure5/Figure_5.pdf', figure_5, units='cm', height=10, width = 15, useDingbats=F)
ggsave('./results/figure5/Figure_5.png', figure_5, units='cm', height=10, width = 15)
