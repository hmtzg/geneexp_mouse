...
exp = readRDS("./data/preprocess/QN_matrix.rds")
...
write.xlsx(table_s1, file='./results/SI_tables/TableS2.xlsx', row.names=F)
...
#       sort(., decreasing = T) %>%
#       gseGO(geneList = ., OrgDb = "org.Mm.eg.db", ont = "BP", keyType = "ENSEMBL", nPerm = 1000, minGSSize = 10,
