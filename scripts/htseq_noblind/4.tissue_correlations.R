...
ggsave('./results/htseq/Figure_S5a.pdf', siggenes_overlap, width = 15, height = 8, units='cm',
       useDingbats = F )
ggsave('./results/htseq/Figure_S5a.png', siggenes_overlap, width = 15, height = 8, units='cm' )  
