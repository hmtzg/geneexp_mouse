...
cov_dat_wo_cortex = readRDS("./data/htseq/no_blind/CoV_wo_cortex.rds")
cov_ch = readRDS('./data/htseq/no_blind/CoV_change.rds')
pexpcors  = readRDS('./data/htseq/no_blind/pairwise_tissue_expression_cors.rds')
...
ggsave('./results/htseq/SI/Figure_S2.pdf',all_nt_pc12, units = 'cm', width = 16, height = 9,
       useDingbats = F)
ggsave('./results/htseq/SI/Figure_S2.png',all_nt_pc12, units = 'cm', width = 16, height = 9)
...
ggsave('./results/htseq/SI/Figure_S3.pdf', dev_raw_pc1234, units = 'cm', width = 16, height = 12,
       useDingbats = F)
ggsave('./results/htseq/SI/Figure_S3.png', dev_raw_pc1234, units = 'cm', width = 16, height = 12)
