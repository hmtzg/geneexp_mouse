...
pca_dat = readRDS('data/htseq/no_blind/pca_data.rds')
...
ggsave("results/htseq/fig1ab.pdf", pab, units = 'cm',width = 19, height = 10, useDingbats = F)
ggsave("results/htseq/fig1ab.png", pab, units = 'cm',width = 20, height = 10)
...
saveRDS(cors, './data/htseq/no_blind//pwise_expch_cors.rds')
diag(cors) = 0
...
save_phmap(corplot, "results/htseq/fig1c_corplot.svg",
           width=15, height=15)
...
ggsave('./results/htseq/fig1d.pdf', pd, units='cm', height = 8, width = 16, useDingbats=F)
ggsave('./results/htseq/fig1d.png', pd, units='cm', height = 8, width = 16)
...
ggsave('./results/htseq/fig1e.pdf', pe, units='cm', height = 8, width = 16, useDingbats=F)
ggsave('./results/htseq/fig1e.png', pe, units='cm', height = 8, width = 16)
...
ggsave('./results/htseq/fig1f.pdf', pf, units='cm', height = 10, width = 8, useDingbats=F)
ggsave('./results/htseq/fig1f.png', pf, units='cm', height = 10, width = 8)
