...
exp = readRDS('./data/other_datasets/jonker/raw/exp_qn2.rds')
...
# saveRDS(genecov,'./data/other_datasets/jonker/processed/CoV2.rds')
...
# saveRDS(cov_dat_sum,file = './data/other_datasets/jonker/processed/mean_cov2.rds')
...
# saveRDS(pexpcors, './data/other_datasets/jonker/processed/pwise_exp_cors2.rds')
...
#save(list=ls(), file = './data/other_datasets/jonker/processed/analysis2.rdata')
