...
tsspec_es = readRDS('./data/processed/figures/raw/ts.spec.ES.rds') %>%
  set_names(c('geneid','tissue','ES','spec')) %>%
  mutate(tissue = setNames(c('Cortex','Liver','Lung','Muscle'),c('cortex','liver','lung','muscle'))[as.character(tissue)]) %>%
  mutate(spec = setNames(c('Cortex','Liver','Lung','Muscle'),c('cortex','liver','lung','muscle'))[as.character(spec)])
tsspec_rho = readRDS('./data/processed/figures/raw/ts.spec.exprho.rds') %>%
...
specdat = full_join(tsspec_es,tsspec_rho) %>%
  mutate(period = factor(ifelse(period == 'Development', 'Development', 'Ageing'), levels = c('Development','Ageing')))
...
ggsave('./results/fig3_rev/cort_sp.pdf',units = 'cm', height = 2.5, width = 6)
...
cort_cort = ggplot(filter(cortdat,tissue == 'Cortex'), aes(x = period , y= rho)) +
  ...
  # stat_summary(color = tissuecol['cortex'], fun = median, fun.min = function(x)quantile(x,0.25), fun.max = function(x)quantile(x,0.75)) +
...
ggsave('./results/fig3_rev/cort_cort.pdf',cort_cort,units = 'cm', height = 5, width = 6)
...
ggsave('./results/fig3_rev/cort_lung.pdf',cort_lung, units = 'cm', height = 2.5, width = 3.1)
...
ggsave('./results/fig3_rev/cort_liver.pdf',cort_liver,units = 'cm', height = 2.5, width = 3.1)
...
ggsave('./results/fig3_rev/cort_muscle.pdf',cort_muscle,units = 'cm', height = 2.5, width = 3.1)
...
ggsave('./results/fig3_rev/cort.pdf',cort_p,units = 'cm',height = 7.5,width = 9)
...
ggsave('./results/fig3_rev/liver_sp.pdf',liver_sp,units = 'cm', height = 2.5, width = 6)
...
ggsave('./results/fig3_rev/liver_liver.pdf',liver_liver,units = 'cm', height = 5, width = 6)
...
ggsave('./results/fig3_rev/liver_cortex.pdf',liver_cort, units = 'cm', height = 2.5, width = 3.1)
...
liver_lung = ggplot(filter(cortdat,tissue == 'Lung'), aes(x = period , y= rho)) +
  ...
  xlab(NULL) +ylab(NULL)+
  ggtitle(paste('Lung, DU:',downup,'%','\nUD:',updown,'%',sep=''))
ggsave('./results/fig3_rev/liver_lung.pdf',liver_lung, units = 'cm', height = 2.5, width = 3.1)
...
liver_muscle = ggplot(filter(cortdat,tissue == 'Muscle'), aes(x = period , y= rho)) +
  ...
  xlab(NULL) +ylab(NULL)+
  ggtitle(paste('Muscle, DU:',downup,'%','\nUD:',updown,'%',sep=''))
ggsave('./results/fig3_rev/liver_muscle.pdf',liver_muscle, units = 'cm', height = 2.5, width = 3.1)
...
ggsave('./results/fig3_rev/liver.pdf',liver_p,units = 'cm',height = 7.5,width = 9)
...
ggsave('./results/fig3_rev/lung_sp.pdf',lung_sp,units = 'cm', height = 2.5, width = 6)
...
ggsave('./results/fig3_rev/lung_lung.pdf',lung_lung,units = 'cm', height = 5, width = 6)
...
lung_cortex = ggplot(filter(cortdat,tissue == 'Cortex'), aes(x = period , y= rho)) +
  ...
  xlab(NULL) +ylab(NULL)+
  ggtitle(paste('Cortex, DU:',downup,'%','\nUD:',updown,'%',sep=''))
ggsave('./results/fig3_rev/lung_cortex.pdf',lung_cortex, units = 'cm', height = 2.5, width = 3.1)
...
lung_liver = ggplot(filter(cortdat,tissue == 'Liver'), aes(x = period , y= rho)) +
  ...
  xlab(NULL) +ylab(NULL)+
  ggtitle(paste('Liver, DU:',downup,'%','\nUD:',updown,'%',sep=''))
ggsave('./results/fig3_rev/lung_liver.pdf',lung_liver, units = 'cm', height = 2.5, width = 3.1)
...
lung_muscle = ggplot(filter(cortdat,tissue == 'Muscle'), aes(x = period , y= rho)) +
  ...
  xlab(NULL) +ylab(NULL)+
  ggtitle(paste('Muscle, DU:',downup,'%','\nUD:',updown,'%',sep=''))
ggsave('./results/fig3_rev/lung_muscle.pdf',lung_muscle, units = 'cm', height = 2.5, width = 3.1)
...
ggsave('./results/fig3_rev/lung.pdf',lung_p,units = 'cm',height = 7.5,width = 9)
...
ggsave('./results/fig3_rev/muscle_sp.pdf',muscle_sp,units = 'cm', height = 2.5, width = 6)
...
ggsave('./results/fig3_rev/muscle_muscle.pdf',muscle_muscle,units = 'cm', height = 5, width = 6)
...
muscle_cort = ggplot(filter(cortdat,tissue == 'Cortex'), aes(x = period , y= rho)) +
  ...
  xlab(NULL) +ylab(NULL)+
  ggtitle(paste('Cortex, DU:',downup,'%','\nUD:',updown,'%',sep=''))
ggsave('./results/fig3_rev/muscle_cortex.pdf',muscle_cort, units = 'cm', height = 2.5, width = 3.1)
...
muscle_liver = ggplot(filter(cortdat,tissue == 'Liver'), aes(x = period , y= rho)) +
  ...
  xlab(NULL) +ylab(NULL)+
  ggtitle(paste('Liver, DU:',downup,'%','\nUD:',updown,'%',sep=''))
ggsave('./results/fig3_rev/muscle_liver.pdf',muscle_liver, units = 'cm', height = 2.5, width = 3.1)
...
muscle_lung = ggplot(filter(cortdat,tissue == 'Lung'), aes(x = period , y= rho)) +
  ...
  xlab(NULL) +ylab(NULL)+
  ggtitle(paste('Lung, DU:',downup,'%','\nUD:',updown,'%',sep=''))
ggsave('./results/fig3_rev/muscle_lung.pdf',muscle_lung, units = 'cm', height = 2.5, width = 3.1)
...
ggsave('./results/fig3_rev/muscle.pdf',muscle_p,units = 'cm',height = 7.5,width = 9)

all_p_rev = ggarrange(cort_p,liver_p,lung_p,muscle_p,ncol=2,nrow=2,labels = c('a.','b.','c.','d.'),font.label = list(size = 10))
ggsave('./results/fig3_rev/fig3_rev.pdf',all_p_rev,units = 'cm',width = 16.7,height = 15, useDingbats = F)
ggsave('./results/fig3_rev/fig3_rev.png',all_p_rev,units = 'cm',width = 16.7,height = 15)
